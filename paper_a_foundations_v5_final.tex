...
\bibitem{PaperI} C.~G.~Smith Jr., ``Holographic acceleration threshold and galaxy rotation curves: A zero-parameter test against the SPARC sample'' (2026), submitted to Phys. Rev. Lett.

\bibitem{PaperVII} C.~G.~Smith Jr., ``Write-lag attractor and the onset of cosmic acceleration in holographic decoherence cosmology'' (2026), in preparation.

\bibitem{PaperVIII} C.~G.~Smith Jr., ``CMB and BAO predictions of holographic decoherence cosmology'' (2026), submitted to Phys. Rev. D.
